...
export const Appbar = () => {
    ...
    const handleMouseLeave = useCallback(() => {
        const id = setTimeout(() => {
            setExpanded(false);
        }, 4000); // 300ms delay before collapsing
        setTimeoutId(id);
    }, []);
                ...
                <div className={`container relative flex items-center ${expanded ? "justify-between" : "justify-center"}`}>
                    ...
                    <div className={`md:flex items-center space-x-6 ${expanded ? "menu-visible" : "menu-hidden"}`}>
                        ...
                        <a
                            ...
                            className="text-white mr-2 hover:text-yellow-300 cursor-pointer transition-all duration-300 hover:-translate-y-0.5"
                        >
                            Offline Buy
                        </a>
                    </div>
                    ...
                    {/* Search Bar */}
                    <div className={`flex grow mx-6 ${expanded ? "menu-visible" : "menu-hidden"}`}>
                        <div className="relative w-full">
                            <input
                                type="text"
                                placeholder="Search for musical instruments..."
                                className="search-input px-4 py-2 w-full rounded-xl text-gray-800 placeholder-gray-500"
                            />
