...
export function Brands() {
  ...
  return (
    <div className="h-auto mx-auto max-w-7xl bg-gray-50">
     {/* <Appbar /> */}
      <div className="flex">
        {/* Sidebar */}
        ...
        <div className="flex-1 p-8">
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl text-center font-bold bg-gradient-to-r from-deal-purple to-deal-orange bg-clip-text text-transparent">
              Featured Brands
            </h1>
